...
A note on Windows compatability
-------------------------------

One of the :ref:`Mangrove design principles <internals_intro>` has always been to make Mangrove cross-platform.
...
If you wish to port Mangrove to windows but do not wish to merge it with the main project, contact a member of the core team directly to discuss official project endorsement.